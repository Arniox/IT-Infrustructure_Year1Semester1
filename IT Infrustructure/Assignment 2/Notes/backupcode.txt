...
PRINT1      LDR    R0, R3, #0  		; Put next file item into R0
	    BRZ    END_PRINT1  		; Loop until next item is 0
...
SWAPPED     ADD     R3, R3, #1  	; Increment file pointer
            ...
            BR      OUTERLOOP   	; End of outer loop
SORTED	    
...
PRINT2      LDR    R0, R3, #0  		; Put next file item into R0
	    ...
	    LDR    R0, R3, #0		; Load back the character to fix bug
            ...
            BR     PRINT2      		; Counter loop
END_PRINT2
	    

HALT

IDNumArray 	.BLKW 10		; Allocate 10 spaces in the RAM for the ID characters entered
